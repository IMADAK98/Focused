package com.ai.spring_ai.mapper.design;
...
public final class DraftMapper {
    ...
    public static AsIsLoop toDomain(com.ai.spring_ai.dto.ai.AsIsLoop draft) {
    ...
    public static ToBeLoop toDomain(String id, com.ai.spring_ai.dto.ai.ToBeLoop draft) {
        List<Stage> stages = draft.stages().stream()
                .map(stage -> new Stage(
                        stage.position(),
                        stage.title(),
    ...
    public static Outcome toDomain(com.ai.spring_ai.dto.ai.Outcome draft) {
